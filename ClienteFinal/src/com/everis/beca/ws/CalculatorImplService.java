 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://ws.beca.everis.com", wsdlLocation = "http://localhost:8080/CalculadoraWS/services/CalculatorImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://ws.beca.everis.com", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculadoraWS/services/CalculatorImpl?wsdl");
    ...
    public CalculatorImpl getCalculatorImpl() {
        return super.getPort(new QName("http://ws.beca.everis.com", "CalculatorImpl"), CalculatorImpl.class);
    }
    ...
    public CalculatorImpl getCalculatorImpl(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.beca.everis.com", "CalculatorImpl"), CalculatorImpl.class, features);
    }
